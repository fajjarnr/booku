    ...
    <section className="2xl:px-20 md:px-10 2xl:mx-auto 2xl:container overflow-y-hidden">
      <div className="md:py-12 py-8 px-4">
        <div className="flex flex-col items-center justify-center mb-12">
          <h1 className="lg:text-3xl md:text-2xl text-xl font-bold leading-10 text-gray-800">
            Brand Pilihan
          </h1>
        </div>
        <div className="flex items-center justify-center mt-10">
          <div className="lg:px-8 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-6 gap-6 w-full">
